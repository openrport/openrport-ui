<template>
    <new-page-wrapper isExtra="true">
                ...
                <div class="mx-auto h-screen max-h-screen max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
                    <div>
                        <div class="relative z-20 flex h-16 items-center justify-between">
                            <div class="">
                                <h3 class="text-3xl leading-6 text-gray-800 dark:text-white">Client groups</h3>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">&nbsp;</p>
                            </div>
                            <div class="flex-1"></div>
                            <div class="ml-2 flex-shrink-0"><a
                                    ...
                                    type="button"><!----><!----><span
                                        class="flex items-center justify-center gap-x-2"><!----> Add group
                                    </span></button>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">&nbsp;</p>
                            </div>
                        </div><!---->
                                                    ...
                                                    <thead class="rounded-lg bg-gray-50 dark:bg-gray-950">
                                                        <tr>
                                                            <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                                scope="col"><button
                                                                    disabled=""><span>ID</span><!----></button></th>
                                                            <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                                scope="col"><button
                                                                    disabled=""><span>Description</span><!----></button>
                                                            </th>
                                                            <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                                scope="col"><button disabled=""><span>Allowed user
                                                                        groups</span><!----></button></th>
                                                            <th class="text-center py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                                scope="col"><button
                                                                    disabled=""><span></span><!----></button></th>
                                                            <th
        ...
        <!-- <div class="container mt-4">
            <page-header title="Client groups" hasAction={true} actionName="Reload" />
