            ...
            <div class="scrollbar-hide max-h-screen flex-1 xl:overflow-y-auto">
                <div class="mx-auto h-screen max-h-screen max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
                    <div class="relative z-20 flex h-16 items-center justify-between">
                        <div class="">
                            <h3 class="text-3xl leading-6 text-gray-800 dark:text-white">User groups</h3>
                    ...
                    <div class="relative z-10 w-full"><!---->
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                <thead class="rounded-lg bg-gray-50 dark:bg-gray-950">
                                                    <tr>
                                                        ...
                                                        <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                            scope="col"><button
                                                                disabled=""><span>Permissions</span><!----></button>
                                                        </th>
                                                        <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                            scope="col"><button
                                                ...
                                                <tbody class="z-10 divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                                                    <tr v-for="(group, key) in userGroups" :key="key"  class="border-t-1 group relative border-gray-200 transition-all duration-300">
                                                        ...
                                                        <td class="text-left min-h-[42px] whitespace-nowrap py-3.5 pl-4 pr-3 text-sm font-normal text-gray-800 dark:text-white sm:pl-6">
                                                            <div class="flex items-center space-x-0.5">
                                                              ...
                                                              <span v-if="permission[1]" class="bg-primary-50 dark:bg-primary-500/10 text-primary-800 dark:text-primary-400 ring-primary-600/20 dark:ring-primary-400/30 px-2 py-1 inline-flex items-center gap-x-1.5 rounded-md text-xs font-medium ring-1 ring-inset">
                                                                <!---->
                                                                <span>
                                                                  <!---->
                                                                </span>
                                                        ...
                                                        <td class="pr-4 sm:pr-6 relative w-8 whitespace-nowrap py-3.5 pl-3 text-right text-sm font-normal">
                                                          <div class="text-blue-600 hover:text-blue-900">
                                                            <HeadlessMenu as="div">
                                                              ...
                                                              <HeadlessMenuItems>
                                                                <div class="z-20">
                                                                  <div class="fixed z-30" :style="{top: 208}">
                                                                      ...
                                                                      <div class="absolute -right-8 -top-0 z-20 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-950">
                                                                        <div class="px-1 py-1" role="none">
                                                                          <button :class="[ active ? 'bg-primary-600 text-white': 'text-gray-800 dark:text-gray-100', 'group flex w-full items-center rounded-md px-2 py-2 text-xs transition-all duration-300 disabled:text-gray-400']" >
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" class="icon mr-2 h-4 w-4" aria-hidden="true">
                                                                              <path fill="currentColor" d="m19.3 8.925l-4.25-4.2l1.4-1.4q.575-.575 1.413-.575t1.412.575l1.4 1.4q.575.575.6 1.388t-.55 1.387L19.3 8.925ZM4 21q-.425 0-.713-.288T3 20v-2.825q0-.2.075-.388t.225-.337l10.3-10.3l4.25 4.25l-10.3 10.3q-.15.15-.337.225T6.825 21H4Z"></path>
                                                                            </svg>
                                                                            <span>Edit</span>
                                                                          </button>
                        ...
                        <p class="mt-3 px-1.5 py-5 text-sm text-theme-inverted-light"> New user groups are created from
                            the
                            user administration. On conflicting permissions, authorization wins over the denial. <a
                                href="https://kb.openrport.io/manage-users-and-permissions" rel="noopener noreferrer"
                                target="_blank"
