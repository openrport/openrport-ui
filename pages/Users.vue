<template>
    <new-page-wrapper isExtra="true">
            ...
            <div class="scrollbar-hide max-h-screen flex-1 xl:overflow-y-auto">
                <div class="mx-auto h-screen max-h-screen max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
                    <div class="relative z-20 flex h-16 items-center justify-between">
                        <div class="">
                            <h3 class="text-3xl leading-6 text-gray-800 dark:text-white">Users</h3>
                                                ...
                                                <thead class="rounded-lg bg-gray-50 dark:bg-gray-950">
                                                    <tr>
                                                        <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                            scope="col"><button disabled=""><span>User</span></button>
                                                        </th>
                                                        <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                            scope="col"><button disabled=""><span>Groups</span></button>
                                                        </th>
                                                        <th class="text-left py-3.5 pl-4 pr-3 text-sm font-semibold text-gray-600 dark:text-gray-200 sm:pl-6"
                                                    ...
                                                    <tr v-for="user in users" :key="user.username"
                                                        ...
                                                        <td
                                                            ...
                                                            <div class="flex items-center space-x-0.5">
                                                                <span
                                                                    class="bg-primary-50 dark:bg-primary-500/10 text-primary-800 dark:text-primary-400 ring-primary-600/20 dark:ring-primary-400/30 px-2 py-1 inline-flex items-center gap-x-1.5 rounded-md text-xs font-medium ring-1 ring-inset"><span>
                                                                    </span>
                                                                    <span v-for="(group, key) in user.groups"
                                                                        :key="key">{{ group }}
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <td
                                                            ...
                                                            <div data-headlessui-state=""
                                                                ...
                                                                <div class="z-20">
                                                                    <div style="top: 208px;" class="fixed z-30">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                ...
                                                <div class="flex w-full items-center justify-between">
                                                    <div class="flex items-center justify-between"><span
                                                            class="text-xs text-gray-500"> Showing <span
                                                                ...
                                                                class="font-medium">1</span> of <span
                                                                class="font-medium">1</span> results </span></div>
                                                    <div class="flex-1"></div>
        ...
        <div class="container mt-4">
            <page-header title="Users" hasAction={true} @action="addUser" actionName="Add user" />
            <div class="card table-responsive">

                <table class="table table-vcenter">
                    <thead class="rounded bg-gray-50">
                        <tr>
                            <th class="py-3 ps-4 pe-4 text-sm-start fw-semibold">User</th>
                            <th class="py-3 ps-4 pe-4 text-sm-start fw-semibold">Groups</th>
                            <th class="w-1"></th>
                        </tr>
                    </thead>
                    <tbody class="bg-white">
                        <tr v-for="user in users" :key="user.username">
                            <td class="text-left py-3 ps-4 pe-4 min-h-[42px] whitespace-nowrap">{{ user.username }}</td>
                            <td class="text-left py-3 ps-4 pe-4 min-h-[42px] whitespace-nowrap">
                                <div class="d-flex align-items-center space-x-0.5">
                                    <span v-for="(group, key) in user.groups" :key="key"
                                        class="tag bg-azure-lt border-azure">{{ group }}</span>
                                </div>
                            </td>
                            <td>
                                !-- <a href="#">Edit</a>--
                                <dropdown-menu>
                                    <dropdown-menu-trigger as-child>
                                        <button>
                                            <div
                                                class="z-20 tw-inline-flex tw-h-8 tw-w-8 tw-items-center tw-justify-center tw-rounded-full tw-bg-opacity-20 tw-p-1 tw-text-gray-600 tw-transition-all tw-duration-300 hover:tw-bg-primary-500 hover:tw-bg-opacity-30 hover:tw-text-gray-200 focus:outline-none">
                                                <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="20px"
                                                    height="20px" viewBox="0 0 24 24" class="icon">
                                                    <path fill="currentColor"
                                                        d="M16 12a2 2 0 0 1 2-2a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2m-6 0a2 2 0 0 1 2-2a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2m-6 0a2 2 0 0 1 2-2a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2Z">
                                                    </path>
                                                </svg>
                                    ...
                                    <dropdown-menu-content class="tw-absolute tw-w-56 -tw-right-3 tw-mt-2">
                                        ...
                                        <div class="tw-px-1 tw-py-1">
                                            <dropdown-menu-item @click="copy(user.username)"
                                                class="focus:tw-text-white focus:tw-bg-gray-500 tw-text-xs">
                                        ...
                                        <div class="tw-px-1 tw-py-1">
                                            <dropdown-menu-item @click="triggerDelete(user)"
                                                class="focus:tw-text-white focus:tw-bg-gray-500 tw-text-xs">
            ...
            <Button @click="testSnack" variant="destructive">Click me</Button>
        </div>
        <AddUser :is_active="userModal" @close="closeModal" :groups="userGroups" @save="createUser"></AddUser>
        <Confirm :is_active="delConfirm" @close="closeModal" @save="deleteUser">
