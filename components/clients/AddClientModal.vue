<template>
	<Modal
		...
		save-button-text="Add Client Access"
		@close="closeModal"
		@save="save"
	>
		<div
				...
				>
					<div class="tw-mr-4">
						<svg
							...
							aria-hidden="true"
							role="img"
							class="tw-icon tw-relative tw-z-20 tw-h-5 tw-w-5"
							width="24px"
							height="24px"
							viewBox="0 0 24 24"
						>
					...
					<div class="tw-relative tw-z-20">
						The password must be at least 12 characters long. Only
						Alphanumeric and the following special characters _ + - . : are allowed.
					</div>
				</div>
				<div
					class="tw-relative tw-mt-1 tw-flex tw-px-4 tw-py-2 tw-text-sm tw-font-normal tw-text-primary before:tw-absolute before:tw-inset-0 before:tw-bg-primary before:tw-bg-opacity-10"
