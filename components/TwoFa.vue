<template>
    <form class="w-full max-w-[400px]" @submit.prevent="verifyTwoFa" novalidate>
        <h1 class="pb-6 text-3xl">Verify it's you</h1>
        <div>
            <div>
                <p class="text-sm"> We've sent you a verification code to <b>{{ send_to }}</b>.
            ...
            <div class="mt-6 flex items-center justify-start">
                <button
                    ...
                    type="submit" @click.prevent="verifyTwoFa">
