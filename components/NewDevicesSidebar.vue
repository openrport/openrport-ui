<template>
	<nav
		aria-label="Sections"
		class="hidden h-screen w-96 flex-shrink-0 overflow-auto border-r border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900 xl:flex xl:flex-col"
	>
		<div>
					...
					<div class="relative flex w-[108px] justify-between gap-0 rounded border border-gray-400 bg-theme-lighter px-1">
						...
						<div v-if="isClientSettingOpen">
							<div class="absolute right-0 top-full z-20 mt-2 w-52 rounded border border-gray-400 bg-white p-2.5 text-gray-900">
								<h3 class="pb-1 text-sm font-normal">
									Client list settings
								</h3>
								<div>
									<button
										class="flex w-full items-center items-center gap-1 rounded-t p-0.5 text-sm font-normal"
										type="button"
										@click="selectItem(1)"
									>
										<svg
											v-if="selectedSettingOpt === 1"
											xmlns="http://www.w3.org/2000/svg"
											width="16px"
											height="16px"
											viewBox="0 0 512 512"
									...
									<button
										class="flex w-full items-center items-center gap-1 p-0.5 text-sm font-normal"
										type="button"
										@click="selectItem(2)"
									>
										<svg
											v-if="selectedSettingOpt === 2"
											xmlns="http://www.w3.org/2000/svg"
											width="16px"
											height="16px"
											viewBox="0 0 512 512"
									...
									<button
										class="flex w-full items-center items-center gap-1 rounded-b p-0.5 text-sm font-normal"
										type="button"
										@click="selectItem(3)"
									>
										<svg
											v-if="selectedSettingOpt === 3"
											xmlns="http://www.w3.org/2000/svg"
											width="16px"
											height="16px"
											viewBox="0 0 512 512"
