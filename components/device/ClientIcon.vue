<template>
	<button
		type="button"
		class="inline-flex items-center duration-200 focus:outline-none rounded-full p-0 flex items-center justify-center p-0  w-7 h-7"
		:class="iconLogo?.color"
	>
		<span
