<template>
    <div class="hidden lg:flex lg:flex-shrink-0">
        <div class="w-56 relative z-40 flex flex-col transition-all">
                ...
                <div class="flex-1">
                    <div class="flex items-center justify-center bg-primary-800 py-4">
                        <div class="flex justify-center py-6 text-white">
                            <span>
                                <svg height="15px" version="1.1" viewBox="0 0 27 15" width="27px"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="Page-1" fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
                                        <g id="Group-16" fill="currentColor"
                                            transform="translate(-28.000000, -31.000000)">
                                            <g id="Group" transform="translate(28.000000, 31.000000)">
                                                <path id="Rectangle"
                                                ...
                                                <polygon id="Path" fill-rule="nonzero" points="13 6 13 9 0 9 0 6">
                                                </polygon>
                                                <rect id="Rectangle" height="3" width="4" x="23" y="6"></rect>
                                            </g>
                                        </g>
                                    </g>
                                </svg>
                    ...
                    <nav class="flex flex-col items-center space-y-3 px-3 py-6">
                        <nuxt-link to="/dashboard"
                            class="nav-link items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 32 32" class="icon h-6 w-6" aria-hidden="true">
                        ...
                        <nuxt-link to="/tunnels"
                            class="items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 24 24" class="icon h-6 w-6" aria-hidden="true">
                                <g fill="currentColor">
                                    <path
                        ...
                        <nuxt-link to="/documentation"
                            class="items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 16 16" class="icon h-6 w-6" aria-hidden="true">
                                <path fill="currentColor"
                        ...
                        <nuxt-link to="/scripts"
                            class="items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 256 256" class="icon h-6 w-6" aria-hidden="true">
                                <path fill="currentColor"
                        ...
                        <nuxt-link to="/library"
                            class="items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 20 20" class="icon h-6 w-6" aria-hidden="true">
                                <path fill="currentColor"
                        ...
                        <a href="#"
                            class="items-start gap-x-4 px-4 flex w-full rounded-lg py-2 text-primary-50 transition-all hover:bg-primary-700 transition-all">
                            <svg data-v-ca945699="" xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                viewBox="0 0 24 24" class="icon h-6 w-6" aria-hidden="true">
                                <path fill="currentColor"
